...
export const pricingApi = {
  ...
  getDealerPricing: async (
    ...
    const response = await fetch(`${config.api.baseUrl}/pricing/dealer?${params}`);
    if (!response.ok) {
  ...
  calculateCustomerPrice: async (
    ...
    const response = await fetch(`${config.api.baseUrl}/pricing/calculate`, {
      method: 'POST',
  ...
  getQuantityBreaks: async (
    ...
    const response = await fetch(`${config.api.baseUrl}/pricing/quantity-breaks?${params}`);
